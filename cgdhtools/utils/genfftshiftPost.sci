// General matrix shift after FFT.
//
...
// such that position row=1, col=1 is shifted to index [0,0]
// (frequency [0,0] is shifted to row=1, col=1 position
//
// Intended use:
...
//
// ---------------------------------------------
function out = genfftshiftPost(in, m, n)
