...
% In case displayKernel is set to true, Figure 3 shows important functions
...
% The images from Figure 3 are saved (in case displayKenels is true) to 
...
fprintf('Point light sources (lambda = %.1f nm) are %.3f mm apart.\n', ...
  lambda * 1e9, pointsDistance * 1e3);
fprintf('Thus, in the plane z = %.1f mm they should create interference fringes\n', ...
  targetZ * 1e3);
fprintf('with spatial frequency %.3f mm^-1, i.e. the fringes should be %.3f mm apart.\n', ...
